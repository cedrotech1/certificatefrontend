...
import { BiUser, BiCategory,BiUpload, BiCalendarCheck, BiCog, BiWorld, BiBuilding, BiTargetLock } from "react-icons/bi";
...
const LandingPage = () => {
  ...
  const adminMenu = [
    ...
    { name: 'Manage students', icon: <BiUser />, to: '/users' },
    { name: 'Upload ', icon: <BiUpload />, to: '/upload' },
    { name: 'certificates', icon: <BsFileBarGraph />, to: '/certificates' },
